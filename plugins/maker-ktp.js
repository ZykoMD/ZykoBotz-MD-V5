...
let handler = async (m, { conn, args }) => {
  ...
  if (!args[0]) throw 'ᴍᴀꜱᴜᴋᴋᴀɴ ᴛᴇxᴛ\nContoh\nktp Nik 087877173955|Nama Zyko-Md|Tempat/Tgl Lahir Pacitan,02-07-2023|Jenis kelamin Laki-laki|Alamat dsn.jeruk|RT/RW 02/02|KevDesa gondosari|Kecamatan punung|Agama Islam|Status Perkawinan pacar Shouko Nishimiya|Pekerjaan nonton anime dirumah|Kewarganegaraan Jepang|Berlaku Hingga Ganti hp lo|Provinsi jawa barat|kabupaten Sukabumi'
  m.reply('ᴘʀᴏꜱᴇꜱ...')
